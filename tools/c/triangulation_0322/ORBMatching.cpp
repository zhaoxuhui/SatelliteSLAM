...
void getMatch2(string path1,string path2,vector<Point2f> &points1,vector<Point2f> &points2,vector<KeyPoint> &keyPoint1,vector<KeyPoint> &keyPoint2,vector<DMatch> &good_matches)
{
  //Step1
  Mat img1 = imread(path1);
  Mat img2 = imread(path2);
